...
# Output:
# - dist/OpenSoul.app
# - dist/OpenSoul-<version>.zip
# - dist/OpenSoul-<version>.dmg
...
APP="$ROOT_DIR/dist/OpenSoul.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenSoul-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenSoul-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenSoul-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenSoul-$VERSION.dSYM.zip"
