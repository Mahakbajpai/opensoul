...
docker run --rm -t \
  ...
  -e OPENSOUL_LIVE_GATEWAY_MODELS="${OPENSOUL_LIVE_GATEWAY_MODELS:-${OPENSOUL_LIVE_GATEWAY_MODELS:-all}}" \
  -e OPENSOUL_LIVE_GATEWAY_PROVIDERS="${OPENSOUL_LIVE_GATEWAY_PROVIDERS:-${OPENSOUL_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e OPENSOUL_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${OPENSOUL_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${OPENSOUL_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
