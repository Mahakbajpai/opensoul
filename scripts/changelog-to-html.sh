...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenSoul $VERSION</h2>"
  echo "<p>Latest OpenSoul update.</p>"
  echo "<p><a href=\"https://github.com/opensoul/opensoul/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
