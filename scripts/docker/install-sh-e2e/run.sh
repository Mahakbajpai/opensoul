...
INSTALL_URL="${OPENSOUL_INSTALL_URL:-${OPENSOUL_INSTALL_URL:-https://opensoul.bot/install.sh}}"
MODELS_MODE="${OPENSOUL_E2E_MODELS:-${OPENSOUL_E2E_MODELS:-both}}" # both|openai|anthropic
INSTALL_TAG="${OPENSOUL_INSTALL_TAG:-${OPENSOUL_INSTALL_TAG:-latest}}"
E2E_PREVIOUS_VERSION="${OPENSOUL_INSTALL_E2E_PREVIOUS:-${OPENSOUL_INSTALL_E2E_PREVIOUS:-}}"
SKIP_PREVIOUS="${OPENSOUL_INSTALL_E2E_SKIP_PREVIOUS:-${OPENSOUL_INSTALL_E2E_SKIP_PREVIOUS:-0}}"
