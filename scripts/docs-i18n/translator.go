...
func NewPiTranslator(srcLang, tgtLang string, glossary []GlossaryEntry, thinking string) (*PiTranslator, error) {
	...
	options.AppName = "opensoul-docs-i18n"
	options.WorkDir = "/tmp"
...
- Keep product names in English: OpenSoul, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenSoul Gateway, use “Gateway 网关”.
