...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opensoulSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenSoulPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenSoulPaths.stateDirURL.path
...
extension Notification.Name {
    static let opensoulSelectSettingsTab = Notification.Name("opensoulSelectSettingsTab")
}
