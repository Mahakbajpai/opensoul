...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenSoul"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenSoulOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenSoulChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opensoul@\(version)"
    }
