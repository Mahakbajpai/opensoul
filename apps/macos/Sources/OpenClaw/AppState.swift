...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenSoulConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenSoulConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenSoulConfigFile.loadDict()
            ...
            OpenSoulConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/opensoul"
        state.remoteCliPath = ""
        return state
    }
}
