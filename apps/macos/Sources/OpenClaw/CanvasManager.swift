...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opensoul", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenSoul/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opensoul__/a2ui/").absoluteString + "?platform=macos"
    }
