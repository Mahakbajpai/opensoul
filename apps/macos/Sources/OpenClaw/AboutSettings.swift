...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/opensoul/opensoul") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/opensoul/opensoul")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opensoul.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "OpenSoulBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "OpenSoulBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenSoulGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenSoulGitCommit") as? String) ??
            "unknown"
    }
