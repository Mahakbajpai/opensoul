...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.opensoul", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".opensoul/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.opensoulCommand(
            subcommand: "gateway",
