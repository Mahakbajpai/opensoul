...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opensoul", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenSoul windows, but below the system’s pop-up menus.
