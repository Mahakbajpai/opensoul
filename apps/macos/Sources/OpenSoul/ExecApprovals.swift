...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.opensoul", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenSoulPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenSoulPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
