...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.opensoul", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenSoulConfigFile.defaultWorkspaceURL() }
