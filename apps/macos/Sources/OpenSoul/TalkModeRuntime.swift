...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.opensoul", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.opensoul", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenSoulChatMessage] = messages.compactMap { item in
