...
public enum OpenSoulCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenSoulCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenSoulCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
