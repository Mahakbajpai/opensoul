...
public typealias OpenSoulPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenSoulPlatformImage = UIImage
#endif

public struct OpenSoulChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenSoulChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenSoulChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenSoulChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenSoulChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenSoulChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenSoulChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenSoulChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenSoulChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenSoulChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenSoulChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenSoulChatMessageContent].self, forKey: .content) {
...
public struct OpenSoulChatHistoryPayload: Codable, Sendable {
...
public struct OpenSoulSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenSoulSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenSoulSessionPreviewItem]
}

public struct OpenSoulSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenSoulSessionPreviewEntry]

    public init(ts: Int, previews: [OpenSoulSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenSoulChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenSoulChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenSoulAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenSoulChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenSoulGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenSoulPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenSoulPlatformImage?
...
public struct OpenSoulChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
