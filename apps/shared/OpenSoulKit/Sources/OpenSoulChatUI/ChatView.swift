...
@MainActor
public struct OpenSoulChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: OpenSoulChatViewModel,
    ...
    private var visibleMessages: [OpenSoulChatMessage] {
        let base: [OpenSoulChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenSoulChatMessage]) -> [OpenSoulChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OpenSoulChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OpenSoulChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenSoulChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenSoulChatMessage) -> String {
