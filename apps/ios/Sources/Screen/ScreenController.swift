...
final class ScreenController {
    ...
    /// Callback invoked when an opensoul:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OpenSoulKitResources.bundle
...
/// Handles navigation policy to intercept opensoul:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept opensoul:// deep links.
        if url.scheme?.lowercased() == "opensoul" {
