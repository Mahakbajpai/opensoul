...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: OpenSoulLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: OpenSoulLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: OpenSoulLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
