## OpenSoul Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_opensoul-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm opensoul gateway --port 18789 --verbose
```
