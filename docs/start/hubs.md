---
summary: "Hubs that link to every OpenSoul doc"
read_when:
...
<Note>
If you are new to OpenSoul, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenSoul assistant](/start/opensoul)
