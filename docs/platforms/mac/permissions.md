...
- Same path: run the app from a fixed location (for OpenSoul, `dist/OpenSoul.app`).
...
Workaround: move files into the OpenSoul workspace (`~/.opensoul/workspace`) if you want to avoid per-folder grants.
