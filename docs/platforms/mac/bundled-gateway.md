...
OpenSoul.app no longer bundles Node/Bun or the Gateway runtime. The macOS app
expects an **external** `opensoul` CLI install, does not spawn the Gateway as a
