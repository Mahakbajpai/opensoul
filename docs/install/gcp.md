---
summary: "Run OpenSoul Gateway 24/7 on a GCP Compute Engine VM (Docker) with durable state"
read_when:
  - You want OpenSoul running 24/7 on GCP
...
If you want "OpenSoul 24/7 for ~$5-12/mo", this is a reliable setup on Google Cloud.
