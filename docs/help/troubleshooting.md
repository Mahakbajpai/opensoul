---
summary: "Symptom first troubleshooting hub for OpenSoul"
read_when:
  - OpenSoul is not working and you need the fastest path to a fix
...
- `opensoul gateway status` → `Runtime: running` and `RPC probe: ok`.
