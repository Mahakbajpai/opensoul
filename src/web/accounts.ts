...
function listConfiguredAccountIds(cfg: OpenSoulConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: OpenSoulConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenSoulConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpenSoulConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenSoulConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenSoulConfig): ResolvedWhatsAppAccount[] {
