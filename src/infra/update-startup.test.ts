...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "opensoul-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpenSoulPackageRoot } = await import("./opensoul-root.js");
    ...
    vi.mocked(resolveOpenSoulPackageRoot).mockResolvedValue("/opt/opensoul");
