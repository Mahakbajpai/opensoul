...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpenSoulConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpenSoulConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpenSoulConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OpenSoulConfig): void {
