...
export function listIMessageAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpenSoulConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpenSoulConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenSoulConfig): ResolvedIMessageAccount[] {
