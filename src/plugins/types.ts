...
export type OpenSoulPluginConfigSchema = {
...
export type OpenSoulPluginToolContext = {
...
export type OpenSoulPluginToolFactory = (
  ctx: OpenSoulPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OpenSoulPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OpenSoulPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OpenSoulConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OpenSoulPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OpenSoul configuration */
  config: OpenSoulConfig;
};
 ...
 */
export type OpenSoulPluginCommandDefinition = {
...
export type OpenSoulPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type OpenSoulPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type OpenSoulPluginCliContext = {
  program: Command;
  config: OpenSoulConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OpenSoulPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OpenSoulPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OpenSoulPluginConfigSchema;
  register?: (api: OpenSoulPluginApi) => void | Promise<void>;
  activate?: (api: OpenSoulPluginApi) => void | Promise<void>;
};

export type OpenSoulPluginModule =
