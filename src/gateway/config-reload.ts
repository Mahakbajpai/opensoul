...
import type { OpenSoulConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OpenSoulConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OpenSoulConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OpenSoulConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OpenSoulConfig) => void;
  log: {
