...
import { type OpenSoulConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenSoulConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenSoulConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenSoulConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenSoulConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpenSoulConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpenSoulConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenSoulConfig): GatewaySessionsDefaults {
