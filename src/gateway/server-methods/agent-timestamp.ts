 ...
 *
 * @see https://github.com/NJX-njx/opensoul/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an OpenSoulConfig.
 */
export function timestampOptsFromConfig(cfg: OpenSoulConfig): TimestampInjectionOptions {
  return {
