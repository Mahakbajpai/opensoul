...
function resolveAnthropicDefaultAuthMode(cfg: OpenSoulConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyTalkApiKey(config: OpenSoulConfig): OpenSoulConfig {
...
export function applyModelDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyLoggingDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyContextPruningDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyCompactionDefaults(cfg: OpenSoulConfig): OpenSoulConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
