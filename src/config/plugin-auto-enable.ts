import type { OpenSoulConfig } from "./config.js";
...
function isTelegramConfigured(cfg: OpenSoulConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenSoulConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenSoulConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenSoulConfig): boolean {
...
function isIMessageConfigured(cfg: OpenSoulConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenSoulConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenSoulConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenSoulConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenSoulConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenSoulConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenSoulConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: OpenSoulConfig, pluginId: string): OpenSoulConfig {
...
function registerPluginEntry(cfg: OpenSoulConfig, pluginId: string): OpenSoulConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
