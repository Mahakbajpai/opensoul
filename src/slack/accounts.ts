...
export function listSlackAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpenSoulConfig): string {
...
function mergeSlackAccountConfig(cfg: OpenSoulConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenSoulConfig): ResolvedSlackAccount[] {
