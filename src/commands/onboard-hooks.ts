...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.opensoul.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("opensoul hooks list")}`,
      `  ${formatCliCommand("opensoul hooks enable <name>")}`,
      `  ${formatCliCommand("opensoul hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
