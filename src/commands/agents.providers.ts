...
function resolveDefaultAccountId(cfg: OpenSoulConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenSoulConfig): boolean {
...
export function summarizeBindings(cfg: OpenSoulConfig, bindings: AgentBinding[]): string[] {
