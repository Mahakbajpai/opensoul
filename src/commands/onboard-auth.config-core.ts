...
export function applyZaiConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyOpenrouterConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyMoonshotProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyMoonshotConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyMoonshotConfigCn(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applySyntheticProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyXiaomiProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenSoulConfig): OpenSoulConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyXaiProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyQianfanProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenSoulConfig): OpenSoulConfig {
