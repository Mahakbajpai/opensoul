...
function resolveConfiguredModelRaw(cfg: OpenSoulConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenSoulConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenSoulConfig, model: string): OpenSoulConfig {
...
export function applyModelAllowlist(cfg: OpenSoulConfig, models: string[]): OpenSoulConfig {
  const defaults = cfg.agents?.defaults;
