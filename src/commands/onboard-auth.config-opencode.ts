...
export function applyOpencodeZenProviderConfig(cfg: OpenSoulConfig): OpenSoulConfig {
...
export function applyOpencodeZenConfig(cfg: OpenSoulConfig): OpenSoulConfig {
