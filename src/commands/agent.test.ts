...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "opensoul-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenSoulConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenSoulConfig["telegram"]>>,
