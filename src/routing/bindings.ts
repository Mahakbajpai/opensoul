...
export function listBindings(cfg: OpenSoulConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OpenSoulConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenSoulConfig) {
