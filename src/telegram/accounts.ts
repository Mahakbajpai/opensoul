...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENSOUL_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenSoulConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenSoulConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpenSoulConfig): ResolvedTelegramAccount[] {
