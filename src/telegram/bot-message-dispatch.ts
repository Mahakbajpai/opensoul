...
import type { OpenSoulConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: OpenSoulConfig, agentId: string) {
  try {
