...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenSoulConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenSoulConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenSoulConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
