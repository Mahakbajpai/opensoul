...
import type { GatewayBindMode, GatewayTailscaleMode, OpenSoulConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.opensoul.ai/gateway/tailscale", "https://docs.opensoul.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
