...
export type ChannelAgentToolFactory = (params: { cfg?: OpenSoulConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenSoulConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenSoulConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenSoulConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenSoulConfig }) => boolean;
