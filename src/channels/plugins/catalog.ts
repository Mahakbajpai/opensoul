...
import type { OpenSoulPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverOpenSoulPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OpenSoulPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["OPENSOUL_PLUGIN_CATALOG_PATHS", "OPENSOUL_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OpenSoulPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OpenSoulPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OpenSoulPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOpenSoulPlugins({ workspaceDir: options.workspaceDir });
