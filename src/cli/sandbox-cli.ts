...
const SANDBOX_EXAMPLES = {
  main: [
    ["opensoul sandbox list", "List all sandbox containers."],
    ["opensoul sandbox list --browser", "List only browser containers."],
    ["opensoul sandbox recreate --all", "Recreate all containers."],
    ["opensoul sandbox recreate --session main", "Recreate a specific session."],
    ["opensoul sandbox recreate --agent mybot", "Recreate agent containers."],
    ["opensoul sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["opensoul sandbox list", "List all sandbox containers."],
    ["opensoul sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["opensoul sandbox recreate --all", "Recreate all containers."],
    ["opensoul sandbox recreate --session main", "Recreate a specific session."],
    ["opensoul sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["opensoul sandbox recreate --browser --all", "Recreate only browser containers."],
    ["opensoul sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["opensoul sandbox explain", "Show effective sandbox config."],
    ["opensoul sandbox explain --session agent:main:main", "Explain a specific session."],
    ["opensoul sandbox explain --agent work", "Explain an agent sandbox."],
    ["opensoul sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.opensoul.ai/cli/sandbox")}\n`,
    )
    .action(() => {
