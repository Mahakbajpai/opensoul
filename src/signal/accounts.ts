...
export function listSignalAccountIds(cfg: OpenSoulConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: OpenSoulConfig): string {
...
function mergeSignalAccountConfig(cfg: OpenSoulConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenSoulConfig): ResolvedSignalAccount[] {
