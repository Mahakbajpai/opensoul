...
import type { OpenSoulPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenSoulPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenSoulPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
