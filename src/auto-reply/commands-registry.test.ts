...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@opensoul", { botUsername: "opensoul" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@opensoul args", {
        botUsername: "opensoul",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@opensoul: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "opensoul" })).toBe(
      "/help@otherbot",
    );
  });
