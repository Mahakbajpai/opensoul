...
function resolveMentionPatterns(cfg: OpenSoulConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenSoulConfig | undefined, agentId?: string): RegExp[] {
