...
export const CANVAS_HOST_PATH = "/__opensoul__/canvas";

export const CANVAS_WS_PATH = "/__opensoul__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opensoulCanvasA2UIAction.postMessage(...)
  // - Android: window.opensoulCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opensoulCanvasA2UIAction"];
  ...
  globalThis.OpenSoul = globalThis.OpenSoul ?? {};
  globalThis.OpenSoul.postMessage = postToNode;
  globalThis.OpenSoul.sendUserAction = sendUserAction;
  globalThis.opensoulPostMessage = postToNode;
  globalThis.opensoulSendUserAction = sendUserAction;
