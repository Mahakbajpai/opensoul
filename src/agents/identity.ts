import type { OpenSoulConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: OpenSoulConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: OpenSoulConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[opensoul]";
}
