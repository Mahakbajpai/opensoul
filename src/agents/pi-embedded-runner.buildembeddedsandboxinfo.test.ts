...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies OpenSoulConfig;

const _ensureModels = (cfg: OpenSoulConfig, agentDir: string) =>
  ensureOpenSoulModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/opensoul-sandbox",
      agentWorkspaceDir: "/tmp/opensoul-workspace",
      ...
      browser: {
        ...
        containerName: "opensoul-sbx-browser-test",
      },
