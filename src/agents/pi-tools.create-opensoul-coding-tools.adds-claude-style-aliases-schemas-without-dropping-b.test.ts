...
describe("createOpenSoulCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenSoulCodingTools({
      config,
    ...
    const anthropicTools = createOpenSoulCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenSoulCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenSoulCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
