...
function resolveAvatarSource(cfg: OpenSoulConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenSoulConfig, agentId: string): AgentAvatarResolution {
