...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenSoulAgentDir() returns mainAgentDir
    process.env.OPENSOUL_STATE_DIR = tmpDir;
    process.env.OPENSOUL_AGENT_DIR = mainAgentDir;
