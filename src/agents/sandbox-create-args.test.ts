  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "opensoul.sandbox=1",
        "--label",
        "opensoul.sessionKey=main",
        "--label",
        "opensoul.createdAtMs=1700000000000",
        "--label",
        "opensoul.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
