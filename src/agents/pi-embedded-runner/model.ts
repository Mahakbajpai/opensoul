...
// pi-ai's built-in Anthropic catalog can lag behind OpenSoul's defaults/docs.
...
export function buildModelAliasLines(cfg?: OpenSoulConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenSoulAgentDir();
