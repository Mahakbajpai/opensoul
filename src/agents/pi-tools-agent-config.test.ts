...
describe("Agent-specific tool filtering", () => {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createOpenSoulCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createOpenSoulCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createOpenSoulCodingTools({
      config: cfg,
    ...
    const defaultTools = createOpenSoulCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createOpenSoulCodingTools({
      config: cfg,
    ...
    const bobTools = createOpenSoulCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createOpenSoulCodingTools({
      config: cfg,
