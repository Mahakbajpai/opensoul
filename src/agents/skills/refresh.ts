...
function resolveWatchPaths(workspaceDir: string, config?: OpenSoulConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenSoulConfig }) {
