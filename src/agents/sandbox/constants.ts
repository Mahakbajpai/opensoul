...
export const DEFAULT_SANDBOX_IMAGE = "opensoul-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opensoul-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opensoul-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opensoul-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opensoul-sbx-browser-";
